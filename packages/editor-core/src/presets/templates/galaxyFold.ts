...
export function buildGalaxyFold(store: DocumentStore): void {
  ...
  function textSimple(title: string, disc: string, bg: string, tc: string) {
    const sec = add("div", page, {
      ...
      layoutProps: {
        direction: "column",
        gap: 8,
        paddingTop: title ? PAD_NRML : 16,
        paddingRight: 40,
        paddingBottom: title ? PAD_NRML : 16,
        paddingLeft: 40,
        alignItems: "center",
      },
      sizing: { w: "fill", h: "hug" },
  ...
  // ════════════════════════════════════════════
  imgBottom("", "", "#000000", "", "//images.samsung.com/kdp/cms_task/C20250625010040/34186/a381670c-7776-43d6-9043-608bda89450f.jpg?$FB_TYPE_A_JPG$", "", 846)
  ...
  // ════════════════════════════════════════════
  imgBottom("", "", "#000000", "", "//images.samsung.com/kdp/cms_task/C20250716000007/35171/16969e6b-58d4-4b55-b1aa-4b7198c75a47.jpg?$FB_TYPE_A_JPG$", "")
  ...
  split5050(
    ...
    "#000000",
    "#ffffff",
    "//images.samsung.com/kdp/cms_task/C20250625010046/34192/ebe00691-1af6-4937-82a1-f0431f9badb8.jpg?$FB_TYPE_B_JPG$",
    "",
    "left"
  )
  ...
  // ════════════════════════════════════════════
  textSimple("", "* 이전 갤럭시 Z 폴드 시리즈와 비교한 결과입니다.\n* 오디오 지우개의 결과는 영상 내 존재하는 소리에 따라 결과는 다를 수 있습니다.", "#000000", "")
  ...
  split5050(
    ...
    "#000000",
    "#ffffff",
    "//images.samsung.com/kdp/cms_task/C20250829000270/36314/ae84d069-c60b-47b0-b49a-7cbbd7274440.jpg?$FB_TYPE_B_JPG$",
    "",
    "right"
  )
  ...
  split5050(
    ...
    "#000000",
    "#ffffff",
    "//images.samsung.com/kdp/cms_task/C20250625010051/34197/d368cfa3-1b00-4fa9-9ea8-d070b8dec353.jpg?$FB_TYPE_B_JPG$",
    "",
    "right"
  )
  ...
  split5050(
    ...
    "#000000",
    "#ffffff",
    "//images.samsung.com/kdp/cms_task/C20250625010053/34199/1733d3a5-b587-4aa8-ba24-40ac77553cc6.jpg?$FB_TYPE_B_JPG$",
    "",
    "left"
  )
  ...
  // ════════════════════════════════════════════
  fullBleed("#ffffff", "//images.samsung.com/kdp/cms_task/C20250625010055/34201/cec0bb3f-2b82-4da4-abdc-52b8f43d265b.jpg?$ORIGIN_JPG$")
  ...
  // ════════════════════════════════════════════
  fullBleed("#ffffff", "//images.samsung.com/kdp/cms_task/C20250725000120/35525/34e042b5-199d-4569-adac-7a068ff6421c.jpg?$ORIGIN_JPG$")
  ...
  // ════════════════════════════════════════════
  textSimple("", "* Now Brief 기능을 사용하려면 삼성 계정 로그인이 필요합니다.\n* 서비스의 이용 가능 여부는 국가 및 언어, 기기 모델, 앱에 따라 다를 수 있습니다.", "#ffffff", "")

  // ════════════════════════════════════════════
  // Component 42: Galaxy AI 요약 정리 title
  // ════════════════════════════════════════════
  textSimple("Galaxy AI로 스마트하고 간편하게 요약 정리", "", "#ffffff", "#000000")
  ...
  // ════════════════════════════════════════════
  fullBleed("#ffffff", "//images.samsung.com/kdp/cms_task/C20250625010067/34213/39c8ed3a-c5c2-4baf-b8ab-7efdbd6b4c64.jpg?$ORIGIN_JPG$")
  ...
  split5050(
    ...
    "#000000",
    "",
    "https://images.samsung.com/kdp/cms_task/C20250924000012/36771/c2ba075e-ce85-4546-807e-14013d34e808.mp4",
    "left"
  )
  ...
  split5050(
    ...
    "#000000",
    "",
    "https://images.samsung.com/kdp/cms_task/C20250716000016/35180/b9d04fd4-8a4e-46d5-98f7-723e5aa37973.mp4",
    "right"
  )
}
