...
export function buildLoginForm(store: DocumentStore): void {
  ...
  add("sc:input", formContainer, {
    name: "Email Input",
    style: { ...rel, width: undefined },
    props: { placeholder: "name@example.com", type: "text" },
    sizing: { w: "fill", h: "hug" },
  })
  ...
  // ── Sign In Button ──
  add("sc:button", formContainer, {
    name: "Sign In",
    style: { ...rel, width: undefined },
    props: { label: "Sign in", variant: "default", size: "default" },
    sizing: { w: "fill", h: "hug" },
  })
  ...
  // ── Social Login Label ──
  add("text", formContainer, {
    name: "Social Login Label",
    style: { ...rel, fontSize: 12, color: m, textAlign: "center" },
  ...
  if (socialRow) {
    add("sc:button", socialRow, {
      name: "Google",
      style: { ...rel, width: undefined },
      props: { label: "Google", variant: "outline", size: "default" },
      sizing: { w: "fill", h: "hug" },
    })
    add("sc:button", socialRow, {
      name: "GitHub",
      style: { ...rel, width: undefined },
      props: { label: "GitHub", variant: "outline", size: "default" },
      sizing: { w: "fill", h: "hug" },
    })
  }
  ...
  add("text", formContainer, {
    name: "Sign Up Link",
    style: { ...rel, fontSize: 13, color: s, textAlign: "center" },
