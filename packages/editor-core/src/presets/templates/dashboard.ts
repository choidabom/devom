...
export function buildDashboard(store: DocumentStore): void {
  ...
  if (header) {
    const hl = add("div", header, {
      ...
      layoutMode: "flex",
      layoutProps: { direction: "column", gap: 2, ...noPad, alignItems: "start" },
      sizing: { w: "hug", h: "hug" },
    })
    if (hl) {
    ...
    for (const st of stats) {
      ...
      if (sc) {
        ...
        const valRow = add("div", sc, {
          ...
          style: { ...rel, width: "auto", height: "auto", ...box },
          layoutMode: "flex",
          layoutProps: { direction: "row", gap: 8, ...noPad, alignItems: "end" as const },
          sizing: { w: "fill", h: "hug" },
        })
        if (valRow) {
  ...
  if (contentRow) {
    ...
    if (rightCol) {
      ...
      if (teamCard) {
        ...
        for (const member of members) {
          const row = add("div", teamCard, {
            ...
            style: { ...rel, width: "auto", height: "auto", ...box },
            layoutMode: "flex",
            layoutProps: { direction: "row", gap: 10, ...noPad, alignItems: "center" },
            sizing: { w: "fill", h: "hug" },
          })
          if (row) {
            ...
            const info = add("div", row, {
              ...
              style: { ...rel, width: "auto", height: "auto", ...box },
              layoutMode: "flex",
              layoutProps: { direction: "column", gap: 0, ...noPad, alignItems: "start" },
              sizing: { w: "fill", h: "hug" },
            })
            if (info) {
      ...
      if (settingsCard) {
        add("sc:switch", settingsCard, {
          name: "Email Notifications",
          style: { ...rel, paddingLeft: 20, paddingRight: 20, paddingTop: 14, paddingBottom: 14, borderBottom: `1px solid ${bd}` },
        ...
        add("sc:switch", settingsCard, {
          ...
          style: { ...rel, paddingLeft: 20, paddingRight: 20, paddingTop: 14, paddingBottom: 14 },
