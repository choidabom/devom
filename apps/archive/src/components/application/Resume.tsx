...
const Resume = (): JSX.Element => {
    return (
        <div className="bg-transparent">
            <img src="./image/devilwearsprada.webp" alt="Book cover" className="max-w-s" />
            <div className="mx-auto min-w-[500px] max-w-[700px] px-4">
                <div className="p-6 font-['NotoSansKorean']">
                    ...
                    Still writing ...
                    <img src="./image/editor.png" alt="Blog rectangle" className="object-contain" />
                    ...
                    <div className="text-center text-xs text-gray-400">
                        개발한 이미지 에디터를 활용하여 블로그 내 이미지들을 종종 만들었습니다.{' '}
                    </div>
                </div>
            </div>
        </div>
