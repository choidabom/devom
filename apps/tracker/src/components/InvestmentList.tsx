    ...
    return [...investments].sort((a, b) => {
      ...
      switch (sortKey) {
        ...
        case "btcAmount":
          ...
          break;
        case "currentValue":
          aValue = calculateProfit(
            a.investmentAmount,
            a.buyPrice,
            currentPrice
          ).currentValue;
          bValue = calculateProfit(
            b.investmentAmount,
            b.buyPrice,
            currentPrice
          ).currentValue;
    ...
    return (
      <TableHead className={className}>
        <Button
          ...
          className={`h-auto p-0 font-medium flex items-center gap-1 hover:text-foreground ${
          ...
          <Table>
            <TableHeader>
              <TableRow>
                ...
                <SortableHeader sortKey="investmentAmount">
                  투자금
                </SortableHeader>
                ...
                <SortableHeader sortKey="currentValue">
                  현재 가치
                </SortableHeader>
                ...
                return (
                  <TableRow key={investment.id}>
                    ...
                    <TableCell className="hidden md:table-cell">
                      ...
                      >
                        {formatPercentage(profit.profitPercentage)}
                      </span>
                    </TableCell>
                    ...
                    <TableCell>
                      <div className="flex items-center gap-1">
                        <Button
                          ...
                          className="h-7 w-7 sm:h-8 sm:w-8 text-blue-500 hover:text-blue-700"
                        >
