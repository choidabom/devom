...
export function ImportJSXModal({ onImport, onClose, warnings }: ImportJSXModalProps) {
  ...
  return (
    <div style={{ position: "fixed", inset: 0, background: "rgba(0,0,0,0.5)", zIndex: 9999, display: "flex", alignItems: "center", justifyContent: "center" }} onClick={onClose}>
      <div
        style={{ background: T.panel, borderRadius: 12, padding: 24, width: 520, maxHeight: "80vh", overflow: "auto", boxShadow: "0 8px 32px rgba(0,0,0,0.12)" }}
      ...
      >
        ...
        <div style={{ display: "flex", justifyContent: "flex-end", gap: 8, marginTop: 16 }}>
          <button
            onClick={onClose}
            style={{ padding: "6px 16px", fontSize: 13, border: `1px solid ${T.inputBorder}`, borderRadius: 6, background: T.panel, cursor: "pointer", color: T.text }}
          >
            Cancel
          </button>
          <button
