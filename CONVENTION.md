# CONVENTION.md
**Frontend Code Convention (Next.js 15 + TypeScript + Shadcn UI)**
...
- 도메인 중심 구조(`domains/user`, `domains/order`)를 사용한다.
...
- @vcat/creagen-components를 기본으로 한다.
- UI 구성요소는 **Shadcn UI** + **Radix Primitives**로 구성한다.
- Tailwind로 빠른 커스터마이징을 적용한다.
